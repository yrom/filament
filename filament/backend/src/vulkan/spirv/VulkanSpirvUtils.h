...
// For certain drivers, using spec constant can lead to compile errors [a] or undesirable behaviors
// [b]. In those instances, we simply change the spirv and set them to constants.
//
// [a]: QC driver cannot use spec constant to size fields
//      (https://github.com/google/filament/issues/6444).
// [b]: An internal driver does not DCE a block guarded by a spec-const boolean set to false
//      (b/310603393).

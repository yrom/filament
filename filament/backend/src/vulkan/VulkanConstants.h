...
#ifndef NDEBUG
//#define FVK_DEBUG_FLAGS FVK_DEBUG_PERFORMANCE | FVK_DEBUG_LAYOUT_TRANSITION | FVK_DEBUG_TEXTURE | FVK_DEBUG_VALIDATION
//#define FVK_DEBUG_FLAGS FVK_DEBUG_PERFORMANCE | FVK_DEBUG_VALIDATION

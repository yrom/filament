...
FFilamentInstance* FAssetLoader::createInstance(const cgltf_data* srcAsset) {
    ...
    FFilamentInstance* instance = new FFilamentInstance(instanceRoot, mResult);
    ...
    importSkins(mResult, instance, srcAsset);
    ...
    instance->boundingBox = mResult->mBoundingBox;
    return instance;
}
...
bool FAssetLoader::createPrimitive(const cgltf_primitive* inPrim, Primitive* outPrim,
        const char* name) {
    Material* material = getMaterial(mResult->mSourceAsset->hierarchy,
